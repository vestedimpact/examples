import { Asset, AssetBasics, AssetBreakdown, AssetCreateInput, AssetCreateResponse, AssetImpact, AssetImpactHistory, AssetSearchResults, ImpactCalculationStatus } from './types';
 ...
 */
export class VestedImpactAssetAPI {
